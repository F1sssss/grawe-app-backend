...
const invoiceData = {
  ...
  items: [
    {
      datum_dokumenta: '2020-01-01',
      broj_dokumenta: 91012023,
      broj_ponude: 54064015,
      vid: 'AVEK',
      opis_knjizenja: 'ZADTAn 225466',
      duguje: 40.88,
      potrazuje: 0,
      saldo: 40.88
    },
...
function generateHeader(doc) {
  doc
    .image('./src/utils/PDFCreation/Grawe.png', 50, 45, { width: 200 })
    .fillColor('#444444')
    .fontSize(20)
    .fontSize(10)
