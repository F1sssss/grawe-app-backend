...
const getReportByName = async (report_name) => {
  ...
  return {
    report_info: data[0][0] === undefined ? {} : data[0][0],
    report_params: data[1] === undefined || data[1][0] === undefined || data[1][0]['param_name'] === null ? [] : data[1],
    statusCode,
  };
};
...
const getProcedureInfo = async (procedure_name) => {
  ...
  return {
    ...
    procedure_params: data[1] === undefined || data[1][0] === undefined || data[1][0]['param_name'] === null ? [] : data[1],
    statusCode,
  };
};
