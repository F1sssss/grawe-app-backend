-- Check for existing group name to prevent duplicates
...
-- Insert new hierarchy group
INSERT INTO gr_hierarchy_groups (name, level_type, parent_id)
VALUES (@name, @levelType, @parentId)
