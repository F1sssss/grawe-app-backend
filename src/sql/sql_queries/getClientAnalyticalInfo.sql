...
where case when len(case when bra_bran not in (10,11,56,8) then k1.kun_yu_persnr else k.kun_yu_persnr end)=12 then '0'+k.kun_yu_persnr else k.kun_yu_persnr end=@id
