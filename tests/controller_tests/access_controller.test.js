const accessControlController = require('../../src/controllers/accessControlController');
const accessControlService = require('../../src/services/accessControlServices');
const ResponseHandler = require('../../src/utils/responseHandler');

jest.mock('../../src/services/accessControlServices');
