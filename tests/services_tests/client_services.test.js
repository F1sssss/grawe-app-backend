...
const FinancialInvoice = require('../../src/utils/Exports/createFinancialInvoice');
const AppError = require('../../src/utils/AppError');
const clientServices = require('../../src/services/clientService');
const clientQueries = require('../../src/sql/Queries/clientQueries');

jest.mock('../../src/utils/cacheQuery');
jest.mock('../../src/sql/Queries/clientQueries');
jest.mock('../../src/utils/Exports/ExcelExport');
jest.mock('../../src/utils/Exports/createInvoice');
jest.mock('../../src/utils/Exports/createFinancialInvoice');
