...
const AdAuth = require('../../src/utils/ADConnection');
const SQLQueries = require('../../src/sql/Queries/userQueries');
const EmailValidator = require('../../src/utils/Email/Email');
...
jest.mock('bcryptjs');
jest.mock('../../src/utils/ADConnection');
jest.mock('../../src/sql/Queries/userQueries');
jest.mock('../../src/utils/Email/Email');
